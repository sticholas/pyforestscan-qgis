...
class CompactWorkspaceTests(unittest.TestCase):
 ...
 def test_tools_synthesizes_system_and_advanced_access(self):
  self.assertIn('super().__init__("Tools & Setup"',self.pages);self.assertIn('QPushButton("Check")',self.pages);self.assertIn('QPushButton("Open Processing Toolbox")',self.pages)
