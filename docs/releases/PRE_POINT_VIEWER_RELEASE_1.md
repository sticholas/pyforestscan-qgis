...
The release ZIP is named `pyforestscan_qgis-v0.2.0-beta.7-pre-point-viewer-release-1.zip`. Future point-viewer work should branch from the tagged baseline rather than rewriting this release history.
