...
CHM is generated once per work unit. It is a supporting output for Rumple-only requests and a requested primary output for CHM plus Rumple requests. Supporting CHM is not published accidentally.
