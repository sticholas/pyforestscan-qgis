...
Phase 31G setup means the complete advertised product runtime. Successful setup immediately runs the module/function/product contract and publishes READY without a second Check action. A missing function, changed protocol, or broken dependency yields repair/update state and never creates a scientific batch.
