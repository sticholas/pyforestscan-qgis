...
Coordinator and scalar CHM execution both pass through `PyForestScanAdapter.create_chm`, whose shared existing-HAG validator writes schema, bounded-read, statistics, and method-decision diagnostics.
