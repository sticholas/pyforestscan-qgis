...
- Product generation uses either PBM backend Python for routed products or QGIS Python for remaining QGIS-Python-only tools. Missing QGIS Python PyForestScan/PDAL packages do not block PBM-routed products when PBM is `Ready`.
