...
SEMANTIC_ACTION_HELP: dict[str, str] = {
    ...
    "Resume Workspace": "Reopen the most recent valid workspace and restore its saved project context without starting processing.",
    "Start New Workspace": "Choose a workspace folder and create new local session metadata there; source LiDAR is not changed.",
    "Open Selected": "Open the workspace selected in the recent-workspaces list without starting a job.",
    "Remove Missing/Selected": "Remove the selected recent-workspace shortcut from Mission Control. Workspace files and outputs are not deleted.",
    "Continue to Dataset": "Open Dataset so you can select and inspect LiDAR for this workspace.",
    "Analyze Dataset": "Read LiDAR metadata and create the Dataset Explorer report; the source point cloud is not modified.",
    "Refresh Dataset Page": "Clear stale Dataset page presentation and re-read the currently selected path and session context.",
    "Select All Products": "Select every release-facing scientific product for the current Product Plan.",
    "Clear Products": "Clear product selections without changing the dataset, output folder, or saved outputs.",
    "Refresh Plan State": "Re-read the active Dataset report and plan files without running scientific processing.",
    "Run Processing": "Run the current validated Product Plan and write its selected outputs to the displayed output folder.",
    "Validate Processing Request": "Check engine compatibility, paths, bounds, coordinate systems, and output writability without generating products.",
    "Cancel": "Request cancellation of the active guided job. Completed output files are retained and source data is not changed.",
    "Refresh Processing State": "Reconcile this page with the current job record and on-disk run state without starting new work.",
    "Finish Planning": "Open Planning to complete the Product Plan required before processing.",
    "Go to Batch": "Open Process for an explicitly selected folder or polygon run; this does not start processing.",
    "Refresh Results": "Re-read outputs registered for the current run without loading or regenerating them.",
    "Open Processing": "Return to Process to configure or review the current job.",
    "Refresh Environment": "Recheck QGIS and the managed Processing Engine and update execution readiness.",
    "Refresh Tools": "Refresh Processing Toolbox availability and provider status without running an algorithm.",
    "View Tool Documentation": "Open the Advanced Processing Toolbox documentation for expert algorithms and parameters.",
}
